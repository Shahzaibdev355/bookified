...
// Create hooks/useVapi.ts: the core hook. Initializes Vapi SDK, manages call lifecycle 
// (idle, connecting, starting, listening, thinking, speaking), tracks messages array + currentMessage streaming, 
// handles duration timer with maxDuration enforcement, session tracking via server actions
